...
function theme.set_highlights(options)
	...
	hl(0, "Variable", { fg = palette.green, bg = "NONE" })
	...
	hl(0, "Identifier", { fg = palette.blue, bg = "NONE" })
	...
	hl(0, "Keyword", { fg = palette.blue, bg = "NONE" })
	...
	hl(0, "@keyword.command", { fg = palette.blue, bg = "NONE", nocombine = true })
	...
	hl(0, "@variable", { fg = palette.green, bg = "NONE" })
	hl(0, "@variable.builtin", { fg = palette.green, bg = "NONE" })
	hl(0, "@variable.builtin.vim", { fg = palette.green, bg = "NONE", italic = options.italics })
	...
	hl(0, "@lsp.type.parameter", { fg = palette.green, bg = "NONE" })
	hl(0, "@lsp.type.property", { fg = palette.cyan5, bg = "NONE" })
	hl(0, "@lsp.type.variable", { fg = palette.green, bg = "NONE" })
